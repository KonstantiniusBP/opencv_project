...
Датасет для обучения и тестирования был создан вручную с использованием инструмента CVAT. Мы собрали и аннотировали видео, где присутствуют автомобили, и использовали этот датасет для обучения модели. Ссылка на датасет предоставлена [здесь](#).
